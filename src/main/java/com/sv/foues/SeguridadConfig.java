...
public class SeguridadConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.
			...
			.antMatchers("/municipios").permitAll()
			.antMatchers("/muni").permitAll()
			.antMatchers("/tipos").permitAll()
			.antMatchers("/odontograma/**").permitAll()
			.antMatchers("/apreciacionperio/**").permitAll()
			...
			.antMatchers("/tactico/**").hasAnyAuthority("ADMIN","TACTICO","ESTRATEGICO").anyRequest()
			...
			.accessDeniedPage("/fichaadmision/access-denied")
			;
